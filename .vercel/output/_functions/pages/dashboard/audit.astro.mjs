...
import { Search, Layers, ShoppingCart, User, Package, Plus, Calendar, Loader2, FileJson, DollarSign, Wallet, Tag, ShieldCheck, RefreshCcw, AlertTriangle } from 'lucide-react';
...
const AuditLogViewer = () => {
  ...
  const getEventIcon = (action2) => {
    if (action2.includes("PRODUCT") || action2.includes("VARIANT")) return /* @__PURE__ */ jsx(Package, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("PEDIDO")) return /* @__PURE__ */ jsx(ShoppingCart, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("INV")) return /* @__PURE__ */ jsx(Plus, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("MONEY") || action2.includes("GASTO") || action2.includes("VENTA")) return /* @__PURE__ */ jsx(DollarSign, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("CASH_BOX")) return /* @__PURE__ */ jsx(Wallet, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("CATEGORY")) return /* @__PURE__ */ jsx(Tag, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("PASSWORD") || action2.includes("ROLE") || action2 === "ENABLE" || action2 === "DISABLE") return /* @__PURE__ */ jsx(ShieldCheck, { className: "w-3.5 h-3.5 text-foreground" });
    if (action2.includes("UPDATE")) return /* @__PURE__ */ jsx(RefreshCcw, { className: "w-3.5 h-3.5 text-foreground" });
    return /* @__PURE__ */ jsx(AlertTriangle, { className: "w-3.5 h-3.5 text-foreground" });
  };
  const getEventCategory = (action2) => {
    const a = action2.toUpperCase();
  ...
  const renderEventText = (log) => {
    ...
    if (displayAction) {
      displayAction = displayAction.replace(/Ã³/g, "ó").replace(/Ã©/g, "é").replace(/Ã¡/g, "á").replace(/Ã­/g, "í").replace(/Ãº/g, "ú").replace(/Ã±/g, "ñ");
    }
    switch (action2) {
      case "PRODUCT_CREATE":
      ...
      case "INVENTORY_IMPORT_EXCEL":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " realizó una ",
          /* @__PURE__ */ jsx("span", { className: "text-primary font-bold", children: "importación masiva" }),
          " desde ",
          /* @__PURE__ */ jsx("span", { className: "underline decoration-green-500/50 decoration-2", children: "Excel" })
        ] });
      case "VARIANT_PRICE_CHANGE":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-foreground font-medium", children: "modificó precios" }),
          " de la variante ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold", children: variantName })
        ] });
      ...
      case "CreÃ³ venta":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " ",
          /* @__PURE__ */ jsx("span", { className: "font-bold text-green-600", children: "registró una venta" })
        ] });
      case "USUARIO_UPDATE_PASSWORD":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-foreground font-medium", children: "cambió su propia contraseña" })
        ] });
      ...
      case "CREATE_USER_SIGNUP":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " ",
          /* @__PURE__ */ jsx("span", { className: "text-foreground font-medium", children: "se registró" }),
          " en el sistema"
        ] });
      case "ENABLE":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      case "MONEY_EXPENSE_CREATE":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " registró un ",
          /* @__PURE__ */ jsx("span", { className: "text-rose-600 font-bold", children: "gasto" }),
          " de ",
      ...
      case "MONEY_EXPENSE_CATEGORY_CREATE":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " creó la categoría de gasto ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold", children: payload.nombre || log.target_label })
        ] });
      case "MONEY_EXPENSE_CATEGORY_UPDATE":
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " actualizó la categoría de gasto ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold", children: payload.nombre || log.target_label })
        ] });
      ...
      case "MONEY_CASH_MOVEMENT_CREATE":
        ...
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " registró un ",
          /* @__PURE__ */ jsx("span", { className: isIngreso ? "text-green-600 font-bold" : "text-rose-600 font-bold", children: isIngreso ? "ingreso" : "egreso" }),
          " de ",
          /* @__PURE__ */ jsxs("span", { className: "font-black", children: [
            "$",
            payload.monto
      ...
      default:
        return /* @__PURE__ */ jsxs(Fragment, { children: [
          boldActor,
          " realizó la acción ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold italic text-foreground/70", children: displayAction }),
  ...
  const renderPayloadDetails = (log) => {
    ...
    if (log.action === "INVENTORY_IMPORT_EXCEL") {
      return /* @__PURE__ */ jsxs("div", { className: "mt-3 grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 bg-primary/5 rounded-xl border border-primary/10 shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-widest leading-none mb-1", children: "Filas" }),
          /* @__PURE__ */ jsx("span", { className: "text-lg font-black tracking-tight", children: data.filas_procesadas || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-l border-primary/10 pl-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-widest leading-none mb-1", children: "Productos" }),
          /* @__PURE__ */ jsx("span", { className: "text-lg font-black tracking-tight", children: data.productos_resueltos || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-l border-primary/10 pl-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-widest leading-none mb-1", children: "Variantes" }),
          /* @__PURE__ */ jsx("span", { className: "text-lg font-black tracking-tight text-primary", children: data.variantes_creadas || 0 })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-l border-primary/10 pl-4", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-widest leading-none mb-1", children: "Stock" }),
          /* @__PURE__ */ jsxs("span", { className: "text-lg font-black tracking-tight text-green-600", children: [
            "+",
            data.unidades_stock_inicial || 0
          ] })
        ] }),
        data.nombre_archivo && /* @__PURE__ */ jsxs("div", { className: "col-span-full pt-2 mt-2 border-t border-primary/10 flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(FileJson, { className: "w-3 h-3 text-muted-foreground" }),
          /* @__PURE__ */ jsxs("span", { className: "text-[10px] font-medium text-muted-foreground truncate italic", children: [
            "Archivo: ",
            data.nombre_archivo
          ] })
        ] })
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                ...
                /* @__PURE__ */ jsx(SelectItem, { value: "pedido", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(ShoppingCart, { className: "w-3.5 h-3.5 text-foreground/70" }),
                ...
                /* @__PURE__ */ jsx(SelectItem, { value: "usuario", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(User, { className: "w-3.5 h-3.5 text-foreground/70" }),
                ...
                /* @__PURE__ */ jsx(SelectItem, { value: "producto", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Package, { className: "w-3.5 h-3.5 text-foreground/70" }),
                ...
                /* @__PURE__ */ jsx(SelectItem, { value: "inventario", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Plus, { className: "w-3.5 h-3.5 text-foreground/70" }),
...
const $$Audit = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Auditor\xEDa | Tu Tienda" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col min-h-screen bg-background"> ${renderComponent($$result2, "Header", $$Header, {})} <div class="flex flex-1 overflow-hidden"> ${renderComponent($$result2, "Sidebar", $$Sidebar, {})} <main class="flex-1 p-4 md:p-8 overflow-x-hidden"> <div class="max-w-5xl mx-auto"> ${renderComponent($$result2, "AuthGuard", AuthGuard, { "client:load": true, "allowedRoles": ["admin", "manager"], "panelName": "Auditor\xEDa", "client:component-hydration": "load", "client:component-path": "@/components/Dashboard/AuthGuard", "client:component-export": "AuthGuard" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "AuditLogViewer", AuditLogViewer, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/Dashboard/Audit/AuditLogViewer", "client:component-export": "AuditLogViewer" })} ` })} </div> </main> </div> ${renderComponent($$result2, "Footer", $$Footer, {})} </div> ` })}`;
}, "C:/Users/aniba/Downloads/OLA WEB OFICIAL/OLA FRONTEND/src/pages/dashboard/audit.astro", void 0);

const $$file = "C:/Users/aniba/Downloads/OLA WEB OFICIAL/OLA FRONTEND/src/pages/dashboard/audit.astro";
