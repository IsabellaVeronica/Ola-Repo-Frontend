/* empty css                                 */
import { e as createComponent, p as renderComponent, r as renderTemplate, m as maybeRenderHead, aj as renderScript } from '../chunks/astro/server_D_CbgPK6.mjs';
import 'piccolore';
...
← Ir al Catálogo
</a> </div> </div> </div> </main> ${renderScript($$result2, "C:/Users/aniba/Downloads/OLA WEB OFICIAL/OLA FRONTEND/src/pages/login.astro?astro&type=script&index=0&lang.ts")} ` })}`;
}, "C:/Users/aniba/Downloads/OLA WEB OFICIAL/OLA FRONTEND/src/pages/login.astro", void 0);

const $$file = "C:/Users/aniba/Downloads/OLA WEB OFICIAL/OLA FRONTEND/src/pages/login.astro";
const $$url = "/login";
