...
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from './card_BjP27i0i.mjs';
import { B as Button } from './button_D3TXvS4A.mjs';
    ...
    return /* @__PURE__ */ jsxs(Card, { className: "max-w-2xl mx-auto mt-12 border-red-200 bg-red-50/30", children: [
      ...
      /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4 text-center pb-8", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted-foreground italic", children: [
          "Tu rol actual es: ",
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-foreground uppercase", children: userRoles.join(", ") || "sin rol" })
        ] }),
